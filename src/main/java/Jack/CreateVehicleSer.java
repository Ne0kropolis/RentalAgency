...
public class CreateVehicleSer
{
 public static void main(String args[])  {
        ...
        try
        {
           ...
           output.writeObject(new Vehicle(1007, "Volvo XC70", 2,   true));
           output.writeObject(new Vehicle(1003, "Merecedes S500", 1,   true));
           output.writeObject(new Vehicle(1005, "BMW X5", 2,   true));
           output.writeObject(new Vehicle(1004, "AUDI A8", 1,   false));
           output.writeObject(new Vehicle(1007, "BMW X3", 2,   true));
           output.close();
